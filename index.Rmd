---
title       : Flight Price Tracker (by Team3 Fanstastic Four)
...
```{r echo=FALSE, fig.cap="Flight Price Tracker App", out.width = '75%'}
knitr::include_graphics("C:\\Users\\User\\Pictures\\app.jpeg")
```
